...
Claude Code reads the mirror of this file as CLAUDE.md.
OpenCode and Codex read this file as AGENTS.md.
...
├── CLAUDE.md              ← mirror of this file (Claude Code)
└── AGENTS.md              ← this file (OpenCode, Codex, others)
```
...
6. Create or update `wiki/authors/<n>.md`
